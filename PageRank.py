...
scores = scores.withColumn('six_point_class', F.when(scores.pr >= top_10_score, F.lit('D')).otherwise(F.col('six_point_class')) )
scores = scores.withColumn('six_point_class', F.when(scores.pr >= top_1_score, F.lit('C')).otherwise(F.col('six_point_class')) )
scores = scores.withColumn('six_point_class', F.when(scores.pr >= top_01_score, F.lit('B')).otherwise(F.col('six_point_class')) )
scores = scores.withColumn('six_point_class', F.when(scores.pr >= top_001_score, F.lit('A')).otherwise(F.col('six_point_class')) )
# ---------------------------------------------- #
